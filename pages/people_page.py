...
from pages.gallery_interface import GalleryInterface
from ui.widgets.common import Translator
from ui.widgets.common import cfg
from ui.widgets.common import StyleSheet
from ui.widgets.common import Trie
...
class peopleInterface(GalleryInterface):
    """ Icon interface """
    ...
    def __init__(self, parent=None):
        ...
        self.setObjectName('peopleInterface')
